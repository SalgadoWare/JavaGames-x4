 ...
 * unmodifiable
 */
public abstract class GameState<S extends GameState<S, A>, A extends GameAction<S, A>> implements Serializable , Cloneable{
	...
	public abstract int at(int row, int col);
	
	//needed for the button to avoid the turn
	//---------------------------------------
